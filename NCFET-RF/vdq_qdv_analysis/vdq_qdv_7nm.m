...
file_MOS_drho="DeviceA_7nm_HP_Ion_drho_vs_xy.txt";
file_MOS_rho="DeviceA_7nm_HP_Ion_rho_vs_xy.txt";
file_MOS_v="DeviceA_7nm_HP_Ion_v_vs_xy.txt";
file_MOS_dv="DeviceA_7nm_HP_Ion_dv_vs_xy.txt";
file_MOS_Ec="DeviceA_7nm_HP_Ion_Ec_vs_xy.txt";


file_MOS_Jn="DeviceA_7nm_HP_Ion_dJn_vs_xy.txt";

file_NC_drho="DeviceNC2_7nm_HP_Ion_drho_vs_xy.txt";
file_NC_rho="DeviceNC2_7nm_HP_Ion_rho_vs_xy.txt";
file_NC_v="DeviceNC2_7nm_HP_Ion_v_vs_xy.txt";
file_NC_dv="DeviceNC2_7nm_HP_Ion_dv_vs_xy.txt";
file_NC_Ec="DeviceNC2_7nm_HP_Ion_Ec_vs_xy.txt";

file_NC_Jn="DeviceNC2_7nm_HP_Ion_dJn_vs_xy.txt";
...
figure;
hold on;
plot(xi_vdq_mos,vdq_mos,'DisplayName','MOSFET - 7nm - vdq','LineWidth',2);
plot(xi_qdv_mos,qdv_mos,'DisplayName','MOSFET - 7nm - qdv','LineWidth',2);
...
figure;
hold on;
plot(xi_vdq_nc,vdq_nc,'DisplayName','NCFET - 7nm - vdq','LineWidth',2);
plot(xi_qdv_nc,qdv_nc,'DisplayName','NCFET - 7nm - qdv','LineWidth',2);
...
figure;
hold on;
plot(xi_v_avg_MOS,v_avg_MOS,'k','DisplayName','MOSFET - 7nm - v','LineWidth',2);
plot(xi_v_avg_NC,v_avg_NC,'r','DisplayName','NCFET - 7nm - v','LineWidth',2);
...
figure;
hold on;
plot(xi_dv_avg_MOS,dv_avg_MOS,'DisplayName','MOSFET - 7nm - dv','LineWidth',2);
plot(xi_dv_avg_NC,dv_avg_NC,'DisplayName','NCFET - 7nm - dv','LineWidth',2);
...
figure;
hold on;
plot(xi_dq_MOS,dq_x_MOS,'DisplayName','MOSFET - 7nm - dq','LineWidth',2);
plot(xi_dq_NC,dq_x_NC,'DisplayName','NCFET - 7nm - dq','LineWidth',2);
...
figure;
hold on;
plot(xi_q_MOS,q_x_MOS,'DisplayName','MOSFET - 7nm - q','LineWidth',2);
plot(xi_q_NC,q_x_NC,'DisplayName','NCFET - 7nm - q','LineWidth',2);
...
figure;
hold on;
plot(xi_Ec_avg_MOS,Ec_avg_MOS-Ec_avg_MOS(1),'k','DisplayName','MOSFET - 7nm - Ec','LineWidth',2);
plot(xi_Ec_avg_NC,Ec_avg_NC-Ec_avg_NC(1),'r','DisplayName','NCFET - 7nm - Ec','LineWidth',2);
